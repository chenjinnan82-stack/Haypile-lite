...
| 平台 | 下载 | 状态 |
| --- | --- | --- |
| macOS Apple Silicon | [应用 ZIP](https://github.com/chenjinnan82-stack/Haypile-lite/releases/download/v0.2.0-test.3/Haypile-v0.2.0-macos-arm64.app.zip) · [SHA-256](https://github.com/chenjinnan82-stack/Haypile-lite/releases/download/v0.2.0-test.3/Haypile-v0.2.0-macos-arm64.app.zip.sha256) | Ad-hoc 签名，未公证 |
| Windows x64 | [便携 ZIP](https://github.com/chenjinnan82-stack/Haypile-lite/releases/download/v0.2.0-test.3/Haypile-v0.2.0-windows-x64.zip) · [SHA-256](https://github.com/chenjinnan82-stack/Haypile-lite/releases/download/v0.2.0-test.3/Haypile-v0.2.0-windows-x64.zip.sha256) | 未签名测试版 |
