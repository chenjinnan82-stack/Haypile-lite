...
from app.services.real_project_binding import (
    HaypileRealProjectBindingError,
...
class RealProjectBindingTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.previous_env = os.environ.get("HAYPILE_REAL_PROJECT_ROOT")
    ...
    def tearDown(self) -> None:
        if self.previous_env is None:
            ...
            os.environ["HAYPILE_REAL_PROJECT_ROOT"] = self.previous_env
    ...
    def test_write_and_resolve_binding_file(self) -> None:
        ...
        payload = write_haypile_real_project_binding(
    ...
    def test_env_overrides_binding_file(self) -> None:
        ...
        os.environ["HAYPILE_REAL_PROJECT_ROOT"] = env_project.as_posix()
    ...
    def test_haypile_env_takes_priority_over_binding_file(self) -> None:
        env_project = self.tmpdir / "haypile-env"
        bound_project = self.tmpdir / "bound"
        env_project.mkdir()
        bound_project.mkdir()
        write_haypile_real_project_binding(
    ...
    def test_clear_binding_is_idempotent(self) -> None:
        ...
        self.assertIsNone(resolve_haypile_real_project_root(binding_path=self.binding_path))
    ...
    def test_rejects_missing_project_root(self) -> None:
        with self.assertRaisesRegex(HaypileRealProjectBindingError, "existing directory"):
            write_haypile_real_project_binding(
