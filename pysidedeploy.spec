...
extra_args = --quiet --assume-yes-for-downloads --noinclude-qt-translations --include-data-dir=ui_assets=ui_assets --include-data-dir=assets=assets --output-filename=Haypile --macos-app-name=Haypile --macos-app-version=0.3.0 --product-name=Haypile --product-version=0.3.0
